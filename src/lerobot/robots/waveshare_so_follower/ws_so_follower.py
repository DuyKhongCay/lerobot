...
from lerobot.motors.waveshare import (
    OperatingMode,
    WaveshareMotorsBus,
)
...
from .ws_config_so_follower import WaveshareSOFollowerRobotConfig

logger = logging.getLogger(__name__)


class WaveshareSOFollower(Robot):
    """
    ...
    config_class = WaveshareSOFollowerRobotConfig
    name = "waveshare_so_follower"

    def __init__(self, config: WaveshareSOFollowerRobotConfig):
        ...
        self.bus = WaveshareMotorsBus(
            ...
            motors={
                ...
                "gripper": Motor(6, "st3215", MotorNormMode.RANGE_0_100),
            },
...
WaveshareSO101Follower = WaveshareSOFollower

SOFollower = WaveshareSOFollower
SO101Follower = WaveshareSO101Follower
